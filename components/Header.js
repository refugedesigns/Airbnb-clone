    ...
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white p-5 shadow-md">
      ...
      <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-md">
        <input
          ...
          className="pl-5 bg-transparent flex-grow focus:outline-none text-sm text-gray-600 placeholder-gray-400"
        />
      ...
      {searchInput && (
        <div className="flex flex-col col-span-3 mx-auto">
          ...
          <div className="flex items-center border-b mb-4">
            ...
            className="w-12 pl-2 outline-none text-lg text-red-400" type="number" min="1"/>
          </div>
          <div className="flex">
            <button 
